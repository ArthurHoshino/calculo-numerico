...
class IntegracaoTrapezioView extends StatefulWidget {
  const IntegracaoTrapezioView({super.key});
...
class _IntegracaoTrapezioViewState extends State<IntegracaoTrapezioView> {
  ...
  final _functionController = TextEditingController(text: 'e^-(x^2)');
  final _limiteAController = TextEditingController(text: '1');
  final _limiteBController = TextEditingController(text: '3');
